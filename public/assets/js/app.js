...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    validate: function validate() {
      this.url === '' ? this.message = 'Поле пустое, введите ссылку!' : this.url.split('.').length < 2 ? this.message = 'Пожалуйста, введите ссылку корректно!' : this.getShortUrl();
    },
...
var render = function () {
  ...
  return _c(
    "div",
    {
      staticClass: "uk-child-width-1-1@m uk-grid-match",
      attrs: { "uk-grid": "" },
    },
    [
      _c("div", [
        _c(
          ...
          {
            staticClass:
              "uk-card uk-card-body uk-card-default uk-box-shadow-medium uk-border-rounded uk-padding-small",
          },
          [
            _c(
              "div",
      ...
      _c("div", [
        _c(
          "div",
          {
            staticClass: "uk-card uk-card-body uk-padding-small uk-text-center",
          },
          [
            _vm.isLoading
              ? _c("div", { attrs: { "uk-spinner": "ratio: 1" } })
              : _vm._e(),
            _vm._v(" "),
            !_vm.isLoading
              ? _c("a", { attrs: { href: _vm.shortUrl, target: "_blank" } }, [
            ...
            _c(
              ...
              {
                staticClass:
                  "uk-text-danger uk-text-center uk-margin-remove-top",
              },
